...
exports.handler = async (event, context) => {
  ...
  const API_KEY = 'AIzaSyAl2JwBaQIWFvbanCMmFEUhKFEJsw5Df0c'; // Necesitas una de Google Cloud
  
  try {
    // 1. Leer datos de Google Sheets
    const url = `https://sheets.googleapis.com/v4/spreadsheets/${1hp_36PFo3y0draB20sSoBxgNFiyoFSr5QL7uyb2PzXE}/values/${Miembros}?key=${AIzaSyAl2JwBaQIWFvbanCMmFEUhKFEJsw5Df0c}`;
